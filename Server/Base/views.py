...
# =========================================
# 🔹 Enregistrement utilisateur (public)
# =========================================
@api_view(['POST'])
...
# =========================================
# 🔹 Récupération des infos utilisateur (public)
# =========================================
@api_view(['GET'])
@permission_classes([AllowAny])
def get_user_data(request):
    data = {
        "message": "Authentification désactivée pour test",
        "example_user": {
            "id": 1,
            "username": "demo_user",
...
# =========================================
# 🔹 Vue CRUD pour les utilisateurs (publique)
# =========================================
class UserViewSet(viewsets.ModelViewSet):
    queryset = User.objects.all().order_by('id')
    serializer_class = UserSerializer
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Pas besoin d’utilisateur connecté
        serializer.save(sender=None)
...
# =========================================
# 🔹 Rapport de transactions (public)
# =========================================
from rest_framework.views import APIView
